    ...
    <div className="min-h-screen bg-gradient-to-br from-soft-pink via-soft-cream to-secondary/30">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-center mb-8">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold ${step >= s ? 'bg-primary text-white' : 'bg-gray-200 text-gray-600'}`}>
                {s}
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {step === 2 && (
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Business Hours & Settings</h2>
              
              <div className="space-y-3 mb-8">
                {Object.entries(formData.hours).map(([day, hours]) => (
                  <div key={day} className="flex items-center space-x-4 p-4 bg-soft-pink/30 rounded-lg">
                    <div className="w-32">
              ...
              <div className="flex justify-between">
                <button
                  onClick={() => setStep(1)}
                  className="px-8 py-3 text-gray-700 hover:bg-gray-100 rounded-lg font-semibold transition-colors"
                >
                  ← Back
                </button>
                <button
          ...
          {step === 3 && (
            <div>
              ...
              <p className="text-gray-600 mb-6">Choose how you want to accept payments from your clients</p>
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-3">Industry-leading payment processor • 2.9% + $0.30 per transaction</p>
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-3">All-in-one payments • 2.9% + $0.30 online, 2.6% + $0.10 in-person</p>
                      <ul className="space-y-1 text-sm text-gray-600">
                        <li className="flex items-center">
                          <svg className="w-4 h-4 mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg mb-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-gray-700">
                    ...
                    <p>Payments go directly to your account. Zentra only charges a monthly subscription fee ($29-$149/month). No transaction fees or revenue sharing.</p>
                  </div>
                </div>
              </div>
