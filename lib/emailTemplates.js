        ...
        <div class="footer">
          ...
          <div style="margin: 25px 0; padding: 20px; background: rgba(255,255,255,0.1); border-radius: 8px; border: 1px solid rgba(255,255,255,0.2);">
            ...
            <div style="text-align: center;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/book/${(appointmentData === null || appointmentData === void 0 ? void 0 : appointmentData.businessId) || 'YOUR_BUSINESS_ID'}?ref=${(appointmentData === null || appointmentData === void 0 ? void 0 : appointmentData.customerName) || 'customer'}" 
