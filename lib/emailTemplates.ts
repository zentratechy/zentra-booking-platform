...
export function generateEmailTemplate(
  ...
  if (process.env.NODE_ENV === 'development') {
    console.log('📧 Email template - appointmentData:', {
      ...
      baseUrl,
      hasBusinessId: !!appointmentData?.businessId,
      hasClientId: !!appointmentData?.clientId,
      fullAppointmentData: JSON.stringify(appointmentData, null, 2)
    });
  }
      ...
      <div class="container">
        ...
        <div class="footer">
          ...
          <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.2); font-size: 12px; opacity: 0.8;">
            <p style="margin: 0 0 8px 0;">You received this email because you have an appointment with ${businessSettings.businessName || 'our business'}.</p>
            <p style="margin: 0;">
