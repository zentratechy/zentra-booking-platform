    ...
    try {
      if (businessId) {
        ...
        if (businessDoc.exists()) {
          ...
          // Always ensure loyaltyProgram is an object, never null or undefined
          businessSettings.loyaltyProgram = (b.loyaltyProgram && typeof b.loyaltyProgram === 'object' && b.loyaltyProgram !== null) ? b.loyaltyProgram : {};
        }
      }
    } catch (e) {
