                  ...
                  {businessData?.dailyReminders?.enabled && (
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Reminders will be sent daily at your chosen hour (UTC) via Vercel Cron</p>
                      </div>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        <button
                          onClick={async () => {
                            ...
                            try {
                              const response = await fetch('/api/test/send-reminders', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
                              ...
                              const data = await response.json();
                              if (response.ok) {
                                showToast(`Test reminder sent! ${data.appointments || 0} appointment(s) included.`, 'success');
                              } else {
                                showToast(data.error || 'Failed to send test reminder', 'error');
                              }
                            } catch (error) {
                        ...
                        >
                          {sendingTestReminder ? 'Sending...' : 'Send Test Reminder Now'}
                        </button>
                      </div>
