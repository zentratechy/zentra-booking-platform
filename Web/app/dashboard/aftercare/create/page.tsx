...
export default function CreateAftercarePage() {
  const { user } = useAuth();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await addDoc(collection(db, 'aftercareTemplates'), templateData);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Create Aftercare Template</h1>
          <p className="text-gray-600">Create a custom aftercare document for your clients</p>
        </div>
