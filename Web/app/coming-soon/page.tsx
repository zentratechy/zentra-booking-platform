        ...
        <div className="text-center mb-12">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto mb-8">
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  required
                  className="flex-1 px-6 py-4 rounded-full border-2 border-rose-200 focus:border-rose-400 focus:outline-none text-gray-700 bg-white/80 backdrop-blur-sm"
                />
                <button
                  type="submit"
                  className="px-8 py-4 bg-gradient-to-r from-rose-400 to-teal-400 text-white rounded-full font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                >
                  Notify Me
                </button>
              </div>
          ...
          <div className="mt-12">
            <button
              ...
              className="text-gray-500 hover:text-gray-700 text-sm font-medium underline decoration-dotted"
            >
